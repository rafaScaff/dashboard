...
for macro in relation:
    url = 'https://daily-caca-api.onrender.com/caca_api/admin/macro'
    payload = {
        "enum": macro 
    }    
    response = requests.post(url=url, json=payload)
    print(f"{macro} - {response.status_code}")
    for micro in relation[macro]:
        url = 'https://daily-caca-api.onrender.com/caca_api/admin/micro'
        payload = {
            "enum": micro,
            "macro_enum": macro
        }    
        response = requests.post(url=url, json=payload)
        print(f"{macro} - {micro} - {response.status_code}")